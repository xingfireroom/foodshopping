...
$('form[name=search]').submit(function(){
	...
	$(this).attr('action','/food/Home/Search/index');
});
...
$('.mod_minicart').mouseenter(function(even){
	...
	$.ajax({
		url:'/food/Home/Showcart/viewInfo',
		type:'post',
		success:function(data){
			if(data == 0) {
...
function viewCartNums(){
	$.ajax({
		url:'/food/index.php/Home/Showcart/viewNums',
		type:'post',
		success:function(data){
...
//分类列表
$.ajax({
	url:'/food/index.php/Home/Index/viewCate',
	type:'post',
	data:{cid:0},
	success:function(data){
		if (data) {
...
$(".enter_sub").click(function(){
	...
	$.ajax({
		url:'/food/index.php/home/Login/enter',
		type:"post",
		data:{"uname":uname,"pwd":pwd},
		success:function(data){
			if(data==1){
				alert('登录成功');
				window.location="/food/index.php/home/index";
			}else{
...
//导航
$.ajax({
	url:"/food/index.php/home/Index/nav",
	dataType:'json',
	success:function(data){
		$("#j_hornav").html('');
