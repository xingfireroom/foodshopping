...
<html lang="zh-cn" class="csstransitions cssanimations ic_webkit ic_chrome ic_latest">
    <head>
        ...
        <!--<link rel="stylesheet" href="/plastic/Public/home/css/bootstrap.min.css" />-->
            ...
            <div class="grid_c1">
                ...
                <div class="mod_sitemap" role="navigation">
                    <ul class="mod_sitemap_ul" id="j_sitemap">
                        ...
                        <li class="mod_sitemap_gap">|</li>
                        <li class="mod_sitemap_li">
                            <a target="_blank" href="/plastic/index.php/Home/Center/news">新闻&nbsp;</a>
                        </li>
                        <li class="mod_sitemap_gap">|</li>
                        <li class="mod_sitemap_li">
                            <a target="_blank" href="/plastic/index.php/Home/Center/zhao">招聘&nbsp;</a>
                        </li>
...
<div class="center_main">
		...
		<div class="center_classify">
			...
			<ul class="center_ul">
				<li style="background:rgb(49,101,176);"><a href="/plastic/index.php/Home/Center/news" style="color:#ffffff;">新闻中心</a></li>
				<li><a href="/plastic/index.php/Home/Center/zhao">网站招聘</a></li>
			</ul>
		</div>
		<div class="center_right">
			<span class="center_indent"><h1>新闻中心</h1></span>
			...
			<div class="collect_goods" style="background:#ffffff">
				<table>
					<?php if(is_array($data)): foreach($data as $k=>$v): ?><tr style="text-align: center;">
						<td style="width:5%;border: 1px dashed gray"><?php echo ($k+1); ?></td>
						<td  style="width:25%;border: 1px dashed gray"><?php echo ($v['title']); ?></td>
						<td style="width:60%;border: 1px dashed gray"><?php echo ($v['content']); ?></td>
						<td style="width:10%;border: 1px dashed gray"><?php echo date('Y-m-d H:i',$v['times']);?></td>
...
<div class="mod_backtop hide" id="j_backtop">
    ...
    <script type="text/javascript" src="/plastic/Public/home/js/addphone.js"></script>
