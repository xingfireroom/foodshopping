...
<div class="center_main">
		...
		<div class="center_classify">
			<h1>资料管理<h1>
				...
				<li style="background:rgb(49,101,176);"><a href="/food/index.php/Home/Center/data" style="color:#ffffff;">个人资料</a></li>
		...
		<div class="data_manage">
			<ul>
				<li><h1>个人资料</h1></li>
				<li>(带<span style="color:red;">*</span>号的项目为必填项)</li>
			</ul>
		</div>
		<div class="data_details">基础资料</div>
		<div class="data_account">
			<div class="data_login">登录账户:</div>
			<form action="/food/index.php/Home/Center/insert" method="post">
			<div class="data_user"><input type="text" value="<?php echo (session('uname')); ?>" class="uname" name="uname"></div>
		</div>
		<div class="data_account">
			<div class="data_login">真实姓名:</div>
			<div class="data_name"><input type="text" name="truename" class="uname" value="<?php echo ($member["truename"]); ?>">
			</div>
		</div>
		<div class="data_account">
			<div class="data_sex">性别:</div>
			<div class="data_sex1">
