...
<div class="center_main">
		...
		<div class="center_classify">
			...
			<ul class="center_ul">
				...
				<li style="background:rgb(49,101,176);"><a href="/food/index.php/Home/Center/collect" style="color:#ffffff;">我的收藏</a></li>
		...
		<div class="center_right">
			<span class="center_indent"><h1>我的收藏</h1></span>
			...
			<?php if(is_array($collectiondata)): foreach($collectiondata as $key=>$v): ?><div class="index_content" style="height:50px;line-height:20px;">
					<ul>
						<li style="width:200px"><?php echo ($v["gnum"]); ?></li>
						<li style="width:200px"><a href="/food/index.php/home/goods/index/gid/<?php echo ($v["gid"]); ?>"><?php echo (mb_substr($v["gname"],0,35,'utf-8')); ?>……</a></li>
						<li style="width:200px">￥<?php echo ($v["goldprice"]); ?></li>
						<li style="width:200px"><a href="/food/index.php/Home/Center/delCollection/id/<?php echo ($v["id"]); ?>">删除</a></li>
					</ul>
				</div>
				<hr style="border:1px solid #eee;" /><?php endforeach; endif; ?>
			<div class="collect_poster">
			</div>
		</div>
</div>
