...
<div class="center_main">
		...
		<div class="center_classify">
			...
			<ul class="center_ul">
				...
				<li style="background:rgb(49,101,176);"><a href="/food/index.php/Home/Center/balance" style="color:#ffffff;">留言</a></li>
		...
		<div class="center_right">
			<span class="center_indent"><h1>留言</h1></span>
			<div>
				<form action="/food/index.php/Home/Center/balance" method="post">
					<textarea name="message" id="" cols="30" rows="10" placeholder="请输入留言内容..."></textarea><br>
					<input type="submit" value="留言" style="width: 80px;height: 30px;border:none;background: blue;color:white">
				</form>
