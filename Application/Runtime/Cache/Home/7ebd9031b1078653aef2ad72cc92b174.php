												...
												<div class="xrating_row1 clearfix">
													...
													<div class="xrating_col">
														...
														<div class="xrating_count">
															...
															<a href="/organic/index.php/Home/Goods/fm/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">非常满意（<?php echo ($co['fm']); ?>）</a>
															...
															<a href="#" style="background:blue ;color:white;display: inline-block;padding:5px;">非常不满意（<?php echo ($co['fb']); ?>）</a>
														</div>
													</div>
												</div>
											</div>
