...
<html lang="zh-cn" class="csstransitions cssanimations ic_webkit ic_chrome ic_latest">
        ...
        <div class="grid_c1">
            <div class="crumb_wrap">
                <div class="crumb_inner" style="width: 10000px; left: 0px;">
                    <a class="crumb_lk" href="/food/index.php/Home/Index/index" >首页</a>
                                ...
                                <?php if(is_array($hotsales)): $i = 0; $__LIST__ = $hotsales;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hotvo): $mod = ($i % 2 );++$i;?><li class="recommend_goods_li" commid="853958">
                                        <div class="mod_goods mod_goods_w60">
                                            <div class="mod_goods_img">
                                                <a class="img"  href="/food/index.php/Home/Goods/index/gid/<?php echo ($hotvo['gid']); ?>" target="_blank" title="">
                                                    <img iguid="8" src="/food/Public/Goodsuploads/<?php echo ($hotvo['gpic']); ?>" height="60" width="60"><span class="recommend_goods_rank"><?php echo ($i); ?></span>
                                                </a>
                                            </div>
                                            <div class="mod_goods_info">
                                                <p class="mod_goods_tit">
                                                    <a  href="/food/index.php/Home/Goods/index/gid/<?php echo ($hotvo['gid']); ?>" target="_blank" title="<?php echo ($hotvo['gname']); ?>"><?php echo ($hotvo['gname']); ?></a>
                                                </p>
                    ...
                    <div class="goods">
                        <ul class="goods_ul" id="itemList">
                            <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goodsvo): $mod = ($i % 2 );++$i;?><li style="cursor: pointer;" class="goods_li">
                                <div class="mod_goods">
                                    <div class="mod_goods_img">
                                        <a class="link_pic" target="_blank" href="/food/index.php/Home/Goods/index/gid/<?php echo ($goodsvo['gid']); ?>" pos="1" >
                                             <img class="lazy" iguid="0" src="/food/Public/home/images/icon/loading-200.gif" data-original="/food/Public/Goodsuploads/<?php echo ($goodsvo['gpic']); ?>" height="200" width="200">
                                        </a>
                                    </div>
                                    <div class="mod_goods_info">
                                        <p class="mod_goods_promo" title=""></p>
                                        <p class="mod_goods_tit"><a href="/food/index.php/Home/Goods/index/gid/<?php echo ($goodsvo['gid']); ?>" target="_blank" title="<?php echo ($goodsvo['gname']); ?>"><?php echo ($goodsvo['gname']); ?></a></p>
                                        <p class="mod_goods_price">
                                            <span class="mod_price">
                                                <i>¥</i><span><?php echo ($goodsvo['goldprice']); ?>.00</span>
                                            </span>
                                            <span class="goods_comments"><a target="_blank" href="/food/index.php/Home/Goods/index/gid/<?php echo ($goodsvo['gid']); ?>" pos="201" ><b><?php echo ($goodsvo['gsellnums']); ?></b>销量</a></span>
                                        </p>
                                ...
                                <div class="mod_carttip_bd clearfix">
                                    ...
                                    <div class="mod_carttip_con">
                                        ...
                                        <div class="mod_carttip_action">
                                            <a class="mod_carttip_btn mod_carttip_btn_bg2 mod_carttip_btn1" onclick="$('.mod_carttip_close').click()" target="_blank" href="/food/index.php/Home/Showcart/index">
                                            <span>去结算</span>
                                            </a>
    ...
    <script src="/food/Public/home/js/search.js"></script>
    <script type="text/javascript" src="/food/Public/home/js/lazyload.js"></script>
    <script type="text/javascript">
        jQuery(document).ready(
            function($){
                $(".lazy").lazyload({
                     placeholder :"/food/Public/home/images/icon/loading.gif",
                     effect: "fadeIn"
                });
        });
    </script>
