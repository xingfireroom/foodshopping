...
<html lang="zh-cn" class="csstransitions cssanimations ic_webkit ic_chrome ic_latest">
	...
	<div class="ic_content xcontent">
		...
		<div class="grid_c1 xcontent_row1">
			<!-- 商品路径面包线导航 -->
			<div class="mod_crumb">
				<a href="/dashboard/index.php/home/index"><strong>首页</strong></a>
				<?php if(is_array($line)): foreach($line as $key=>$vo): ?><i>&gt;</i><a href="/dashboard/index.php/Home/Search/index/cid/<?php echo ($vo["cid"]); ?>.html" class="lk_0"><?php echo ($vo["cname"]); ?></a><?php endforeach; endif; ?>
		...
		<div class="grid_c1 xcontent_row2" itemscope="" itemtype="http://schema.org/Product">
			<div class="grid_s">
						...
						<div class="xgallery_thumb_wrapper" id="list_smallpic">
							...
							<ul style="width: 425px;" class="xgallery_thumb_list clearfix">
								<li class="current" idx="0">
									<a hidefocus="true"><img src="/dashboard/Public/goodsuploads/<?php echo ($sxw_goodsPic[0]); ?>"></a>
								</li>
								<li idx="1">
									<a hidefocus="true"><img src="/dashboard/Public/goodsuploads/<?php echo ($sxw_goodsPic[1]); ?>"></a>
								</li>
								<li idx="2">
									<a hidefocus="true"><img src="/dashboard/Public/goodsuploads/<?php echo ($sxw_goodsPic[2]); ?>"></a>
								</li>
								<li idx="3">
									<a hidefocus="true"><img src="/dashboard/Public/goodsuploads/<?php echo ($sxw_goodsPic[3]); ?>"></a>
								</li>
								<li idx="4">
									<a hidefocus="true"><img src="/dashboard/Public/goodsuploads/<?php echo ($sxw_goodsPic[4]); ?>"></a>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="xsns clearfix">
					<div class="xfav">
						<a id="sea_add_favor" href="/dashboard/index.php/Home/Goods/goodsCollection/gid/<?php echo ($item["gid"]); ?>" class="mod_btn mod_btn_bg1" ytag="24300"><span>收藏</span></a>
					</div>
					<div class="xshare">
							...
							<div style="display: block;" class="xscan hide" id="sea_code_wrap">
	  							<div class="xscan_col1">
									<div class="xscan_code" id="sea_code">
	  									<img src="/dashboard/Public/images/qrcode.png" _src="http://api.item.yixun.com/2dcode/qrcode?scene=item&amp;size=80&amp;param=P%3D1118345%26Y%3D1500000" alt="商品二维码" width="80">
									</div>
	  							</div>
	  							<div class="xscan_col2">
									...
									<div class="xscan_bigcode" id="sea_bigcode">
	  									<img src="/dashboard/Public/images/qrcode_002.png" src="http://api.item.yixun.com/2dcode/qrcode?scene=item&amp;size=230&amp;param=P%3D1118345%26Y%3D1500000" alt="商品二维码">
												...
												<div class="xrating_row1 clearfix">
													...
													<div class="xrating_col">
														...
														<div class="xrating_count">
															...
															<a href="#" style="background: blue;color:white;display: inline-block;padding:5px;">全部（<?php echo ($count); ?>）</a>
															<a href="/dashboard/index.php/Home/Goods/fm/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">非常满意（<?php echo ($co['fm']); ?>）</a>
															<a href="/dashboard/index.php/Home/Goods/m/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">满意（<?php echo ($co['m']); ?>）</a>
															<a href="/dashboard/index.php/Home/Goods/yb/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">一般（<?php echo ($co['yb']); ?>）</a>
															<a href="/dashboard/index.php/Home/Goods/bm/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">不满意（<?php echo ($co['bm']); ?>）</a>
															<a href="/dashboard/index.php/Home/Goods/fb/gid/<?php echo ($item['gid']); ?>" style="background: gray;color:white;display: inline-block;padding:5px;">非常不满意（<?php echo ($co['fb']); ?>）</a>
														</div>
													</div>
												</div>
											</div>
				  						...
				  						<li>
				  							<div class="mod_goods x_mod_goods">
				  								<div class="mod_goods_img">
				  									<a target="_blank" href="/dashboard/index.php/home/goods/index/gid/<?php echo ($vo["gid"]); ?>" title="<?php echo ($vo["gname"]); ?>">
				  										<img src="/dashboard/Public/goodsuploads/<?php echo (implode('/120_',explode('/',$vo["gpic"]))); ?>" alt="<?php echo ($vo["gname"]); ?>">
				  									</a>
				  								</div>
				  								<div class="mod_goods_info">
				  									<p class="mod_goods_tit">
				  										<a target="_blank" href="/dashboard/index.php/home/goods/index/gid/<?php echo ($vo["gid"]); ?>" title="<?php echo ($vo["gname"]); ?>"><?php echo ($vo["gname"]); ?></a>
				  									</p>
			...
			<div class="mod_carttip_bd clearfix">
				...
				<div class="mod_carttip_con">
					...
					<div class="mod_carttip_action">
						<a class="mod_carttip_btn mod_carttip_btn_bg2 mod_carttip_btn1" onclick="$('.mod_carttip_close').click()" href="/dashboard/index.php/home/Showcart" >
							<span>去结算</span>
						</a>
	...
	<script type="text/javascript" src="/dashboard/Public/home/js/gb.js"></script>
	<script type="text/javascript">
		...
		function ajaxhandle(){
			...
			$.ajax({
				url:"/dashboard/index.php/Home/Goods/showCart",
				type:"post",
