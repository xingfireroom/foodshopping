				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								查看会员信息
								<a class="btn btn-info btn-sm pull-right" href="/organic/admin.php/Admin/Member/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Member/update" method="post" enctype="multipart/form-data">
