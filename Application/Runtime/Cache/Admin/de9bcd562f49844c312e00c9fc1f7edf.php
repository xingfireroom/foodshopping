...
<html lang="en">
	...
	<link rel="stylesheet" href="/food/Public/admin/css/datepicker.css" />
				...
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Indexset/insertAd');?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写广告URL" name="fadurl">
							</div>
						</div>
	...
	<script src="/food/Public/admin/js/date-time/bootstrap-datepicker.min.js"></script>
	<script type="text/javascript">
		jQuery(function($) {
