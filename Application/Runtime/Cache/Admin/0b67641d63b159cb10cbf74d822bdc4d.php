                    ...
                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Goodsclass/updataClass');?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" id="selparent">
                                ...
                                <?php if(is_array($path)): $ci = 0; $__LIST__ = $path;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$child): $mod = ($ci % 2 );++$ci;?><div id="menu-0" class="col-xs-10 col-sm-2  no-padding">                                        
                                        <select class="form-control">
                                            <option value="<?php echo ($curr[$ci-1]); ?>">--</option>
                                            <?php if(is_array($child)): foreach($child as $key=>$vo): ?><option value="<?php echo ($vo['cid']); ?>" <?php echo ($vo["cid"]==$curr[$ci]?'selected':''); ?>><?php echo ($vo['cname']); ?></option><?php endforeach; endif; ?>
                                        </select>
                                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
                        <input class="col-xs-10 col-sm-5" id="showid" name="parentid" value="<?php echo ($curr[$ci]); ?>" type="hidden">
