				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								添加新闻
								<a class="btn btn-info btn-sm pull-right" href="/plastic/index.php/Admin/News/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/plastic/index.php/Admin/News/add" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 新闻标题 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="title">
										</div>
									</div>
									
								
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 新闻内容 </label>
										<div class="col-sm-10">
