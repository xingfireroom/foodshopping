                                ...
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                            ...
                                            <a name="del_<?php echo ($vo['cid']); ?>" class="red" data-toggle="modal" href="#deleteModal">
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                       url:"/food/index.php/Admin/Goodsclass/deleteClass",
                       type:"post",
                       data:{cid:delid},
                       success:function(data){
                            if (data == 1) {
                                ...
                                warningInfo('#error-info',"删除失败，需要先删除推荐");
                            }else if(data == 3){
