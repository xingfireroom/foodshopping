											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($article)): foreach($article as $key=>$vo): ?><tbody>
													<tr>
														...
														<td><?php if($vo["an_times"] != 0): echo date('Y-m-d H:i:s',$vo['an_times']); endif; ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<?php if($vo["answer"] == ''): ?><a name="table-edit" class="green" href="<?php echo U('Admin/Message/mod',array('id'=>$vo['id']));?>">
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/food/index.php/Admin/Message/del",
                               type:"get",
                               data:{id:delid},
