    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row" style="margin-top:35px;">
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" action="<?php echo U('Admin/Goodsattr/updataAttr');?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="attrid" value="<?php echo ($_GET['id']); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right"> 所属分类 </label>
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写属性名称" value="<?php echo ($data['cname']); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" name="attrsort" value="<?php echo ($data['attrsort']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="col-xs-10 col-sm-5" type="text" placeholder="请填写属性名称" name="attrname" value="<?php echo ($data['attrname']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" id="attrlist">
                                <?php if(is_array($val)): foreach($val as $key=>$vo): ?><input class="col-xs-10 col-sm-5" type="text" placeholder="请填写属性值" name="attrval[]" value="<?php echo ($vo['attrvalue']); ?>"><a class="remove" href="#"><i class="icon-remove"></i></a><br /><br /><?php endforeach; endif; ?>
                                <?php if($vo == 0): ?><input class="col-xs-10 col-sm-5" type="text" placeholder="请填写属性值" name="attrval[]"><a class="remove" href="#"><i class="icon-remove"></i></a><br /><br /><?php endif; ?>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#selparent').on('change','select',function(){
                ...
                $.ajax({
                    url:"/organic/admin.php/Admin/Goodsclass/viewClassId",
                    type:'post',
