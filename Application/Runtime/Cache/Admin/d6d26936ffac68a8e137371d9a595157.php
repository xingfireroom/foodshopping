				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								修改导航链接
								<a class="btn btn-info btn-sm pull-right" href="/organic/admin.php/Admin/Navsetting/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Navsetting/update" method="post" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo ($nav["nid"]); ?>" name="nid">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 导航名称 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($nav["nname"]); ?>"placeholder="请填写导航名称" name="nname">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 排序编号 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($nav["nsort"]); ?>"placeholder="请填写导航名称" name="nsort">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($nav["nweb"]); ?>"placeholder="请填写导航链接网址" name="nweb">
										</div>
									</div>
									<!--文件上传-->
