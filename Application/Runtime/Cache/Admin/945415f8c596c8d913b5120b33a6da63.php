	...
	<body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
										<!--<div>
										<form action="/organic/admin.php/Admin/Articleclasses/search" method="post" style="margin-bottom:5px;">
										...
										<a href="/organic/admin.php/Admin/Articleclasses/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i> 添加友情链接</small></a>
										</form>
				...
				<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                ...
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/organic/admin.php/Admin/Articleclasses/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加分类
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/organic/admin.php/Admin/Articleclasses/search" method="get">
                                    <div class="input-group pull-right">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<!--一行的开始-->
												<!--遍历查询到的数据-->
												<?php if(is_array($article)): foreach($article as $key=>$v): ?><tbody>
													<tr>
														<td>
															<?php echo ($v["acid"]); ?>
														</td>															
														<td><?php echo ($v["acname"]); ?></td>											<td><?php echo ($v["acsort"]); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="green" href="/organic/admin.php/Admin/Articleclasses/mod/acid/<?php echo ($v["acid"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a name="del_<?php echo ($v["acid"]); ?>" class="red" data-toggle="modal" href="#deleteModal">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				//设置当前页面的菜单高亮显示 开始
				var nownav = "#sidebar a[href*=News]";
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/organic/admin.php/Admin/News/del",
                               type:"get",
                               data:{acid:delid},
