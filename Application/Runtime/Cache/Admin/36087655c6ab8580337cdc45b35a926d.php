        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
										<!--<div>
										<form action="/plastic/index.php/Admin/News/search" method="post" style="margin-bottom:5px;">
										...
										<a href="/plastic/index.php/Admin/News/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i> 添加友情链接</small></a>
										</form>
				...
				<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                ...
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/plastic/index.php/Admin/News/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加新闻
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/plastic/index.php/Admin/News/search" method="get">
													...
													<tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a name="table-edit" class="green" href="<?php echo U('Admin/News/mod',array('id'=>$vo['id']));?>">
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/plastic/index.php/Admin/News/del",
                               type:"get",
                               data:{id:delid},
