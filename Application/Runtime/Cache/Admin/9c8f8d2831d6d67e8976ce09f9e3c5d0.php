				...
				<div class="col-xs-12">
					...
					<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
						...
						<div class="col-xs-12 col-sm-4">
							<form action="/food/index.php/Admin/Goodsdown/search" method="get">
								...
								<?php if(is_array($goodupdata)): foreach($goodupdata as $key=>$vo): ?><tr>
										...
										<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="/food/index.php/Admin/Goodsdown/modgoods/gid/<?php echo ($vo["gid"]); ?>">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#delete-data').on('click',function(){
				$.ajax({
					url:"/food/index.php/Admin/Goodsdown/delgoods",
					type:"get",
					data:{gid:delid},
					// 执行成功执行以下函数，返回值为data
			...
			$('#up-goods').on('click',function(){
				$.ajax({
					url:"/food/index.php/Admin/Goodsdown/upGoods",
					type:"get",
					data:{gid:upid},
					// 执行成功执行以下函数，返回值为data
					success:function(data){
