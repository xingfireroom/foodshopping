    ...
    <script type="text/javascript">
        jQuery(function($) {         
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/deleteAd",
                    type:"post",
            ...
            $('#addsure').on('click',function(){
                ...
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/addFloor",
                    type:"post",
                    data:{cid:fclass,frsort:fsort},
                    success:function(data){
                        if (data == 1) {
                            warningInfo('#success-info','推荐添加成功!');
                            location.href="/food/index.php/Admin/Indexset/index";
                        }else if(data == 2){
            ...
            $('#modifysure').on('click',function(){
                ...
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/modifyFloor",
                    type:"post",
            ...
            $('#deletefloor-data').on('click',function(){
                ...
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/deleteFloor",
                    type:"post",
            ...
            function loadData(floor,page,fadplace){
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/loadData",
                    type:"post",
            ...
            function loadText(floor,tpage){
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/loadText",
                    type:"post",
            ...
            function viewClass(id){
                $.ajax({
                    url:"/food/index.php/Admin/Indexset/viewClass",
                    type:"post",
                    datatype:'json',
                    success:function(data){
