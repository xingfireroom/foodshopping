...
<html lang="en">
            ...
            <div class="row">
                <div class="col-xs-12">                    
                    ...
                    <p>
                       ...
                       <a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Member/index');?>">
                            <i class="icon-group bigger-230"></i>
                            会员管理
                        </a>
                       <a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Goodsclass/index');?>">
                            <i class="icon-list bigger-230"></i>
                            商品分类
                        </a>
                      <a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Goodsup/index');?>">
                            <i class="icon-asterisk bigger-230"></i>
                            商品管理
                        </a>
                      <a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Ordermanage/index');?>">
                            <i class="icon-bar-chart bigger-230"></i>
                            订单管理
                        </a>
                        <a class="btn btn-app btn-default no-radius" href="<?php echo U('Admin/Reviewmanage/index');?>">
    ...
    <script src="/food/Public/admin/js/jquery.slimscroll.min.js"></script>
    <script src="/food/Public/admin/js/jquery.easy-pie-chart.min.js"></script>
    <script src="/food/Public/admin/js/jquery.sparkline.min.js"></script>
    <script src="/food/Public/admin/js/flot/jquery.flot.min.js"></script>
    <script src="/food/Public/admin/js/flot/jquery.flot.pie.min.js"></script>
    <script src="/food/Public/admin/js/flot/jquery.flot.resize.min.js"></script>
    <script type="text/javascript">
        jQuery(function($) {
            //设置当前页面的菜单高亮显示 开始
