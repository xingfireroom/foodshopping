...
<html lang="en">
                            ...
                            <div class="col-xs-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <!--<div>
                                        <form action="/food/index.php/Admin/Member/search" method="get" style="margin-bottom:5px;">
                                        ...
                                        <a href="/food/index.php/Admin/Member/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i>    添加用户</small></a>
                                        </form>
                                        </div>-->
                <!--搜索-->
                <div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                <div class="col-xs-12 col-sm-8">
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/food/index.php/Admin/Member/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加用户
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/food/index.php/Admin/Member/search" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text"  name="uname" value="<?php echo ($uname); ?>" placeholder="输入搜索内容...">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                <a class="blue" href="/food/index.php/Admin/Member/mod/uid/<?php echo ($v["uid"]); ?>">
    ...
    <script type="text/javascript">
                    ...
                    $.ajax({
                        url:"/food/index.php/Admin/Member/del",
                        type:"get",
                        data:{uid:delid},
