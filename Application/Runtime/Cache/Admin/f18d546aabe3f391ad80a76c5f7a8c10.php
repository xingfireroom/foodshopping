	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="row" style="margin-top:35px;">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Adset/updataAd');?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-10">
                                <div class="col-xs-10 col-sm-5  no-padding">
                                    <select class="form-control" name="adplace">
                                        ...
                                        <option value="1" <?php echo ($adinfo['adplace']==1?"selected":""); ?>>首页顶部</option>
                                        <option value="2" <?php echo ($adinfo['adplace']==2?"selected":""); ?>>首页幻灯片</option>
                                        <option value="3" <?php echo ($adinfo['adplace']==3?"selected":""); ?>>首页抢购</option>
                                        <option value="4" <?php echo ($adinfo['adplace']==4?"selected":""); ?>>搜索页</option>
                                        <option value="5" <?php echo ($adinfo['adplace']==5?"selected":""); ?>>商品页</option>
                                        <option value="6" <?php echo ($adinfo['adplace']==6?"selected":""); ?>>全站</option>
                                    </select>
                                </div>
                            </div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($adinfo['adtitle']); ?>" name="adtitle">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"> 广告URL </label>
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="TEXT" value="<?php echo ($adinfo['adurl']); ?>" name="adurl">
							</div>
						</div>
						<div class="form-group" style="margin-bottom:0px;">
							...
							<div class="col-sm-10">
                                ...
                                <img class="full-right" style="margin-left:10px;" src="/plastic/Public/Uploads/<?php echo (implode('/th_',explode('/',$adinfo['adpic']))); ?>" height="30">
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="col-xs-10 col-sm-5 no-padding" >
									<div class="input-group">
										...
										<input style="height:30px;" class="form-control date-picker" id="id-date-picker-1" type="text" data-date-format="yyyy-mm-dd" name="adstarttime" value="<?php echo (date('Y-m-d',$adinfo['adstarttime']>0?$adinfo['adstarttime']:'')); ?>">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="col-xs-10 col-sm-5 no-padding" >
									<div class="input-group">
										...
										<input style="height:30px;" class="form-control date-picker" id="id-date-picker-2" type="text" data-date-format="yyyy-mm-dd" name="adendtime" value="<?php echo (date('Y-m-d',$adinfo['adendtime']>0?$adinfo['adendtime']:'')); ?>">
									</div>
								</div>
							</div>
						</div>
