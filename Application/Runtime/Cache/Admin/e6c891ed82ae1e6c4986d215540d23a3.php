...
<html lang="en">
	...
	<body>
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								修改文章
								<a class="btn btn-info btn-sm pull-right" href="/organic/admin.php/Admin/Articlemanage/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Articlemanage/update" method="post" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo ($articlemanage["aid"]); ?>" name="aid">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 所属分类 </label>
										<div class="col-sm-10">
											<select name="pacid" id="" style="width:100px;">
											<?php if(is_array($articleclasses)): foreach($articleclasses as $key=>$v): ?><option  <?php if(($v["acid"]) == $articlemanage["pacid"]): ?>selected<?php endif; ?> value="<?php echo ($v["acid"]); ?>"><?php echo ($v["acname"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写文章标题" name="atitle" value="<?php echo ($articlemanage["atitle"]); ?>">
										</div>
									</div>
									<!--<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 文章内容 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写内容" name="acontent" value="<?php echo ($articlemanage["acontent"]); ?>">
										</div>
									</div>-->
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 文章内容 </label>
										<div class="col-sm-10">
											...
											<textarea id="content" name="acontent">
														<?php echo (htmlspecialchars_decode($articlemanage["acontent"])); ?>
											</textarea>
										</div>
									</div>
		...
		window.UEDITOR_HOME_URL = "/organic/Public/admin/js/ueditor/";
		</script>
		<!-- 加载配置文件 2-->
