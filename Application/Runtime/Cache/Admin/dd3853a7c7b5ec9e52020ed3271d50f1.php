	...
	<body>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
										<!--<div>
										<form action="/organic/admin.php/Admin/Memlevel/search" method="post" style="margin-bottom:5px;">
										...
										<a href="/organic/admin.php/Admin/Memlevel/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i> 添加友情链接</small></a>
										</form>
				...
				<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                ...
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/organic/admin.php/Admin/Memlevel/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加会员等级
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/organic/admin.php/Admin/Memlevel/search" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text" name="lname" value="<?php echo ($lname); ?>" placeholder="输入搜索内容...">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<!--一行的开始-->
												<!--遍历查询到的数据-->
												<?php if(is_array($memlevel)): foreach($memlevel as $key=>$v): ?><tbody>
													<tr>
														<td class="center">
															<?php echo ($v["lid"]); ?>
														</td>
														...
														<td class="hidden-480"><img src="/organic/Public/MemlevelUploads/<?php echo (implode('/l_',explode('/',$v["licon"]))); ?>" alt=""></td>
														<td><?php echo ($v["needscores"]); ?></td>
														<td><?php echo ($v["llevel"]); ?></td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/organic/admin.php/Admin/Memlevel/mod/lid/<?php echo ($v["lid"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a name="del_<?php echo ($v["lid"]); ?>" class="red" data-toggle="modal" href="#deleteModal">
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				//设置当前页面的菜单高亮显示 开始
				var nownav = "#sidebar a[href*=Memlevel]";
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/organic/admin.php/Admin/Memlevel/del",
                               type:"get",
                               data:{lid:delid},
