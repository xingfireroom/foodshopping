				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/food/index.php/Admin/Websetting/update" method="post" enctype="multipart/form-data">
									<input type="hidden" name="wid" value="<?php echo ($data["wid"]); ?>" />
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 网站名称 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="wname" value="<?php echo ($data["wname"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 网站描述 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text"  name="wdescribe" value="<?php echo ($data["wdescribe"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 微博 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="weibo" value="<?php echo ($data["weibo"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> QQ </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="qqnum" value="<?php echo ($data["qqnum"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 微信 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="weixin" value="<?php echo ($data["weixin"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 联系方式 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="wcontact" value="<?php echo ($data["wcontact"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 商家地址 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="wlocation" value="<?php echo ($data["wlocation"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 备案号 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" name="wrecords" value="<?php echo ($data["wrecords"]); ?>">
										</div>
									</div>
									<!--文件上传-->
									<div class="form-group" style="margin-bottom:0px;">
										...
										<div class="col-sm-10">
											...
											<img src="/food/Public/Uploads/<?php echo (implode('/w_',explode('/',$data["wlogo"]))); ?>" />
										</div>
