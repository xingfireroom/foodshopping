			...
			<div class="row" style="margin-top:35px;">
				<div class="col-xs-12">
					<form class="form-horizontal" role="form" action="<?php echo U('Admin/Indexset/editAd');?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="ftid" value="<?php echo ($_GET['id']); ?>">
                        <input type="hidden" name="adtype" value="text">

						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"> 文字标题 </label>
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($adinfo['ftext']); ?>" name="ftext">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label no-padding-right"> 文字URL </label>
							<div class="col-sm-10">
								<input class="col-xs-10 col-sm-5" type="text" value="<?php echo ($adinfo['fturl']); ?>" name="fturl">
							</div>
						</div>
