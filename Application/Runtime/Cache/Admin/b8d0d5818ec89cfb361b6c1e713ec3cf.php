				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								修改文章分类
								<a class="btn btn-info btn-sm pull-right" href="/organic/admin.php/Admin/Articleclasses/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Articleclasses/update" method="post" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo ($article["acid"]); ?>" name="acid">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 文章分类名 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写分类名" name="acname" value="<?php echo ($article["acname"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 排序编号 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写排序编号" name="acsort" value="<?php echo ($article["acsort"]); ?>">
										</div>
									</div>
