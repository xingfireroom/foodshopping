			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
							...
							<a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/food/index.php/admin/goodsissue">
								<i class="icon-plus-sign bigger-125"></i>
								商品发布
							</a>
						</div>
						<div class="col-xs-12 col-sm-4">
							<form action="/food/index.php/Admin/Goodsup/search" method="get">
						...
						<table id="sample-table-2" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php if(is_array($goodupdata)): foreach($goodupdata as $key=>$vo): ?><tr>
										<td class="center"><?php echo ($vo["gid"]); ?></td>
										<td class="center"  width="80px">
											<img width="40px" src="/food/Public/Goodsuploads/<?php echo (implode('/30_',explode('/',$vo["gpic"]))); ?>">
										</td>
										...
										<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												...
												<a class="green" href="/food/index.php/Admin/Goodsup/modgoods/gid/<?php echo ($vo["gid"]); ?>">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#delete-data').on('click',function(){
				$.ajax({
					url:"/food/index.php/Admin/Goodsup/delgoods",
					type:"get",
					data:{gid:delid},
					// 执行成功执行以下函数，返回值为data
			...
			$('#down-goods').on('click',function(){
				$.ajax({
					url:"/food/index.php/Admin/Goodsup/downgoods",
					type:"get",
					data:{gid:downid},
					// 执行成功执行以下函数，返回值为data
					success:function(data){
