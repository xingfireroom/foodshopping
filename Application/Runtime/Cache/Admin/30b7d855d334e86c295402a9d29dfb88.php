                        ...
                        <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td><img src="/organic/Public/Uploads/<?php echo (implode('/th_',explode('/',$vo['brandpic']))); ?>" alt="<?php echo ($ad['adpic']); ?>" width="80"></td>
                                    <td>
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $('#delete-data').on('click',function(){
                $.ajax({
                       url:"/organic/admin.php/Admin/Goodsbrand/deleteBrand",
                       type:"post",
                       data:{bid:delid},
