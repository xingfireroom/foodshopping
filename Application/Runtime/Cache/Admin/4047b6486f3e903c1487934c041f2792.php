        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
										...
										<!--<div>
										<form action="/organic/admin.php/Admin/Navsetting/search" method="post" style="margin-bottom:5px;">
										...
										<a href="/organic/admin.php/Admin/Navsetting/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i> 添加导航</small></a>
										</form>
				...
				<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                ...
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/organic/admin.php/Admin/Navsetting/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加导航
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/organic/admin.php/Admin/Navsetting/search" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text" value="<?php echo ($nname); ?>" name="nname" placeholder="输入搜索内容...">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php if(is_array($nav)): foreach($nav as $key=>$v): ?><tbody>
													<tr>
														<td class="center"><?php echo ($v["nid"]); ?></td>
														<td>
															<?php echo ($v["nname"]); ?>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/organic/admin.php/Admin/Navsetting/mod/nid/<?php echo ($v["nid"]); ?>">
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/organic/admin.php/Admin/Navsetting/del",
                               type:"get",
                               data:{nid:delid},
