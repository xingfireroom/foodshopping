				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								修改会员等级
								<a class="btn btn-info btn-sm pull-right" href="/organic/admin.php/Admin/Memlevel/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Memlevel/update" method="post" enctype="multipart/form-data">
								<input type="hidden" value="<?php echo ($memlevel["lid"]); ?>" name="lid">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 等级名称</label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写等级名称" name="lname" value="<?php echo ($memlevel["lname"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 会员等级 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写排序编号" name="llevel" value="<?php echo ($memlevel["llevel"]); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 所需积分 </label>
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="number" placeholder="请填写积分" name="needscores" value="<?php echo ($memlevel["needscores"]); ?>">
										</div>
									</div>
									<!--文件上传-->
									<div class="form-group" style="margin-bottom:0px;">
										<label class="col-sm-2 control-label no-padding-right"> 等级图标 </label>
										<div class="col-sm-10">
											<div class="ace-file-input no-padding col-xs-10 col-sm-5">
												<input style="height:30px;" type="file" id="id-input-file-2" name="licon" />

											</div>
											<img src="/organic/Public/MemlevelUploads/<?php echo (implode('/l_',explode('/',$memlevel["licon"]))); ?>">
										</div>
									</div>
