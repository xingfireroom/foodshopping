        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-collapse" id="sidebar-collapse">
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/food/index.php/admin/index">首页</a>
							</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
										<!--<div>
										<form action="/food/index.php/Admin/Friendlink/search" method="post" style="margin-bottom:5px;">
										...
										<a href="/food/index.php/Admin/Friendlink/insert" class="btn btn-primary"><small><i class="icon-plus-sign bigger-125"></i> 添加友情链接</small></a>
										</form>
				...
				<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
                                ...
                                <a class="btn btn-primary pull-left" style="padding:1px 10px;" href="/food/index.php/Admin/Friendlink/insert">
                                    <i class="icon-plus-sign bigger-125"></i>
                                    添加友情链接
                                </a>
                            </div>
                            <div class="col-xs-12 col-sm-4">
                                <form action="/food/index.php/Admin/Friendlink/search" method="get">
                                    <div class="input-group pull-right">
                                        <input class="form-control search-query" type="text" name="fname" value="<?php echo ($fname); ?>" placeholder="输入搜索内容...">
										...
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<!--一行的开始-->
												<!--遍历查询到的数据-->
												<?php if(is_array($friend)): foreach($friend as $key=>$v): ?><tbody>
													<tr>
														<td class="center"><?php echo ($v["fid"]); ?></td>

														<td>
															<?php echo ($v["fname"]); ?>
														</td>
													
														<td class="hidden-480"><img src="/food/Public/FriendUploads/<?php echo (implode('/f_',explode('/',$v["flogo"]))); ?>" alt=""></td>
														<td><?php echo ($v["furl"]); ?></td>
														<td><?php echo (date("Y-m-d H:s",$v["ftime"])); ?></td>
														<td><?php echo ($v["fsort"]); ?></td>
														<td><?php echo ($v["fcontact"]); ?></td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="/food/index.php/Admin/Friendlink/mod/fid/<?php echo ($v["fid"]); ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a name="del_<?php echo ($v["fid"]); ?>" class="red" data-toggle="modal" href="#deleteModal">
				...
				//设置当前页面的菜单高亮显示 结束
				 ...
				 //全选js
                    ...
                    $('#delete-data').on('click',function(){
                        $.ajax({
                               url:"/food/index.php/Admin/Friendlink/del",
                               type:"get",
                               data:{fid:delid},
