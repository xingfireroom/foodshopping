				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Articlemanage/add" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-2 control-label no-padding-right"> 选择分类 </label>
										<div class="col-sm-10">
										<select name="pacid" id="" style="width:100px;">
											<?php if(is_array($articleclasses)): foreach($articleclasses as $key=>$v): ?><option value="<?php echo ($v["acid"]); ?>"><?php echo ($v["acname"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="text" placeholder="请填写文章标题" name="atitle">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<textarea id="content" name="acontent" cols="30" rows="10" >
