				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>
								添加用户
								<a class="btn btn-info btn-sm pull-right" href="/food/index.php/Admin/Member/index">
						...
						<div class="row" style="margin-top:35px;">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="/food/index.php/Admin/Member/add" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="col-xs-10 col-sm-5" type="password" placeholder="请确认密码" name="rpwd">
										</div>
									</div>
									<div class="form-group">
