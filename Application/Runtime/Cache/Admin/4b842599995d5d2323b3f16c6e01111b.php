...
<html lang="en">
	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="/organic/admin.php/admin/goodsup">上架商品</a>
				</li>
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					商品修改
					<a href="/organic/admin.php/admin/Goodsup" class="btn btn-info btn-sm pull-right">
	...
	<div class="main-container">
		<div class="col-xs-9">
			<form class="form-horizontal" role="form" action="/organic/admin.php/Admin/Goodsup/updategoods" method="post" enctype="multipart/form-data">
				<!-- 商品编号 -->
